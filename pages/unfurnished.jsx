...
export default function UnfurnishedPage() {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      const snapshot = await getDocs(collection(db, "unfurnished"));
  ...
  return (
    <DashboardLayout>
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold">🏠 Unfurnished Apartments</h1>
        <p className="text-gray-600">Long-term student rentals with more freedom and lower costs.</p>
